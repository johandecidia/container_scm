...
class ProductMetadata:
    ...
    Note: name, description, and features support Django lazy translation strings.
    """

    stripe_id: str
    slug: str
    name: StrOrPromise
    features: list[StrOrPromise]
...
class PlanIntervalMetadata:
    ...
    Note: name and help_text support Django lazy translation strings.
    """
...
def get_plan_name_for_interval(interval: str) -> StrOrPromise:
    return {
...
def get_help_text_for_interval(interval: str) -> StrOrPromise:
    return {
